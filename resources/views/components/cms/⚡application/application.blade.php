        ...
        <form class="space-y-6" wire:submit.prevent="submit">
            <div>
                <flux:heading size="lg">
                    {{ $isUpdate ? 'Update' : 'Create' }} Application Item
                </flux:heading>
                <flux:text class="mt-2">
                    {{ $isUpdate ? 'Update the details of the application item below.' : 'Fill in the details to create a new application item.' }}
                </flux:text>
            </div>
            ...
            <flux:field>
                ...
                <flux:text>Application name.</flux:text>
            ...
            <flux:field>
                ...
                <flux:text>Application package_name.</flux:text>
                <flux:textarea wire:model="package_name" rows="3" />
