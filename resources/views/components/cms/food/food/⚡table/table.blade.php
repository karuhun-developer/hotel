<div>
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-0 mt-5 mb-4">
        ...
        <div class="w-full md:w-auto flex items-center gap-4">
            <x-ui.filter.select :data="$this->foodCategories" model="foodCategoryFilter" label="Filter Food Category" placeholder="-- All Food Categories --" changeEvent="" />
        </div>
        <div class="w-full md:w-auto flex items-center gap-4">
    ...
    <livewire:cms.food.food.create-update lazy />
</div>
