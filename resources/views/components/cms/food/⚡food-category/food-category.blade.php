        ...
        <form class="space-y-6" wire:submit.prevent="submit">
            <div>
                <flux:heading size="lg">
                    {{ $isUpdate ? 'Update' : 'Create' }} food category
                </flux:heading>
                <flux:text class="mt-2">
                    {{ $isUpdate ? 'Update the details of the food category below.' : 'Fill in the details to create a new food category.' }}
                </flux:text>
            </div>
            ...
            <flux:field>
                ...
                <flux:text>Food category name for identification.</flux:text>
            ...
            <flux:field>
                ...
                <flux:text>Food category description.</flux:text>
