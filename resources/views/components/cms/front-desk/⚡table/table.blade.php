<div>
        ...
        <flux:table.rows>
            @forelse($data as $d)
                <flux:table.row>
                    ...
                    <flux:table.cell>
                        {{ $d->check_in ? \Carbon\Carbon::parse($d->check_in)->format('Y-m-d H:i:s') : '-' }}
                    </flux:table.cell>
                    <flux:table.cell>
                        {{ $d->check_out ? \Carbon\Carbon::parse($d->check_out)->format('Y-m-d H:i:s') : '-' }}
                    </flux:table.cell>
                    <flux:table.cell>
    ...
    <livewire:cms.front-desk.create-update lazy />
</div>
