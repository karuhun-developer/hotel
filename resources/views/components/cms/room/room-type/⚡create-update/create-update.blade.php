        ...
        <form class="space-y-6" wire:submit.prevent="submit">
            <div>
                <flux:heading size="lg">
                    {{ $isUpdate ? 'Update' : 'Create' }} Room Type
                </flux:heading>
                <flux:text class="mt-2">
                    {{ $isUpdate ? 'Update the details of the room type below.' : 'Fill in the details to create a new room type.' }}
                </flux:text>
            </div>
            ...
            @if (auth()->user()->isSuperAdmin())
                <flux:field>
                    ...
                    <flux:select wire:model="tenant_id" placeholder="Select tenant ....">
            ...
            <flux:field>
                ...
                <x-file-preview :file="$image" :form_file="$record?->getFirstMediaUrl('images')" />
