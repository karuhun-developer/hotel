        ...
        <form class="space-y-6" wire:submit.prevent="submit">
            ...
            @if (auth()->user()->isSuperAdmin())
                <flux:field>
                    ...
                    <flux:select wire:model.live="tenant_id" placeholder="Select tenant ...." wire:change="getContents">
            ...
            <flux:field>
                ...
                <flux:text>Select the content to be displayed in the room.</flux:text>
                <flux:select id="content_id" wire:model.live="content_id" placeholder="Select content ....">
            ...
            <flux:field>
                ...
                <flux:text>Content item name.</flux:text>
            ...
            <flux:field>
                ...
                <flux:text>Content item description.</flux:text>
