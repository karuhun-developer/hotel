...
render(function (View $view) {
    ...
    $description = 'Manage the enabled channels for the tenant "' . $tenant->name . '". You can activate or deactivate channels as needed.';
    $breadcrumbs = [
        ['label' => 'Tenants', 'url' => route('cms.tenant.index')],
        ['label' => 'Enabled Channels', 'url' => null],
    ];
...
<x-layouts.app :$title>
    <div class="w-full">
        ...
        <livewire:cms.tenant.channel.table :$tenant />
    </div>
</x-layouts.app>
